...
//eraser = false and drawing = false initiallt as user hasn't started using both
...
let recTop = canvas.getBoundingClientRect().top;
...
const getXY = (e) => {
    ...
    mouseY = (!is_touch_device() ? e.pageY : e.touches?.[0].pageY) - recTop;
};
...
eraseButton.addEventListener("click", () => {
    erase_bool = true;
    //set range title to erase sizze
